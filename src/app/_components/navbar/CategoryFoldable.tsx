...
function SportsFoldable() {
  ...
  if (status === 'pending') {
    return (
      <div className="flex cursor-not-allowed flex-row items-center justify-center gap-2 rounded-sm border border-neutral-600/10 bg-neutral-200/95 px-10 py-1 font-semibold text-nowrap whitespace-nowrap shadow-md backdrop-blur-sm transition duration-200 ease-in-out hover:bg-neutral-300/80 xl:bg-neutral-200/80 dark:border-neutral-400/10 dark:bg-neutral-800/95 dark:shadow-neutral-500/10 dark:hover:bg-neutral-700/80 xl:dark:bg-neutral-800/80">
        <Spinner />
      </div>
    );
  }
