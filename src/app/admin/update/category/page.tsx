      ...
      <div className="flex flex-wrap items-center justify-center gap-2">
        {sports.map((sport) => (
          <div key={sport.id} className="w-[20rem]">
            <div className="flex h-full w-full flex-col items-center gap-2 rounded-sm border border-slate-600/10 bg-slate-200/30 py-4 dark:border-slate-400/10 dark:bg-slate-800/30">
              <div className="flex flex-1 flex-col items-center justify-center gap-2">
                <Link
                  href={`/admin/update/category/${sport.id}`}
                  className="rounded-sm border border-slate-600/10 bg-slate-200/30 px-4 py-2 hover:border-slate-600/40 hover:bg-slate-300/30 dark:border-slate-400/10 dark:bg-slate-800/30 dark:hover:bg-slate-700/30">
                  {' '}
