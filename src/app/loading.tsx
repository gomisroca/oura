    ...
    <div className="absolute top-0 right-0 bottom-0 left-0" aria-busy="true" aria-label="Loading content">
      <div className="absolute top-0 right-0 left-0 flex min-h-screen flex-col items-center justify-evenly overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          <div className="h-[3.5rem] w-[80vw] animate-pulse rounded-sm border border-slate-600/10 bg-slate-200/30 shadow-md md:w-[25vw] 2xl:w-[10vw] dark:border-slate-400/10 dark:bg-slate-800/30 dark:shadow-slate-500/10"></div>
          <div className="h-[25rem] w-[20rem] animate-pulse rounded-sm border border-slate-600/10 bg-slate-200/30 shadow-md dark:border-slate-400/10 dark:bg-slate-800/30 dark:shadow-slate-500/10"></div>
        </div>
      </div>
    </div>
  );
