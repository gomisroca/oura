...
export default function AboutSettings() {
    ...
    const fetchAboutSettings = async() => {
        await axios.get<AboutSettings>(`${import.meta.env.VITE_REACT_APP_API_URL}/settings/about`)
        .then((res) => {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        await axios.post<void>(`${import.meta.env.VITE_REACT_APP_API_URL}/settings/about` , formData).then(res => {
            if(res.status === 201){
